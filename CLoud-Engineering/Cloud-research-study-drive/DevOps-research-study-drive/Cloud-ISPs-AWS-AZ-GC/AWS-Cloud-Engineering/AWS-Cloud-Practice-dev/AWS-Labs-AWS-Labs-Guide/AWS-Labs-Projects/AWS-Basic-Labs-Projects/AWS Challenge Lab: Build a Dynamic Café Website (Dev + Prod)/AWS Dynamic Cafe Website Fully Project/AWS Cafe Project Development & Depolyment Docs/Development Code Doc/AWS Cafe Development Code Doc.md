...
📋 STEP 3 — COPY THIS FULL FINAL CODE
✅ (PHASE 11 + PHASE 12 — ENV VAR VERSION)
...
---
☕ CAFE LAB
📊 PHASE 9️⃣ — EXACT ANALYTICS LAMBDA RESPONSE (ENV-BASED CONFIG)
...
🧮 PHASE 9️⃣ — Analytics Lambda Using Environment Variables (Production-Ready)
...
🧠 What Was Replaced with Environment Variables
Previously Hard-coded	Environment Variable
CafeOrders	ORDERS_TABLE_NAME
order_date-index	ORDERS_GSI_NAME
Access-Control-Allow-Origin: "*"	ALLOWED_ORIGIN
🧩 REMODIFIED PHASE 9 LAMBDA CODE (ENV-BASED)
...
| Cafe branding                | ✅                         |
| Trending food cards          | ✅                         |
| Charts sections              | ✅ (UI-ready placeholders) |
| Fully responsive             | ✅                         |
| Fully commented              | ✅                         |


### 🖥️ FULL DASHBOARD FRONTEND CODE
...
dashboard.html
```
✅ COMPLETE CODE (WITH COMMENTS, NO BACKEND)
```
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>Foodie Kitchen | Cafe Dashboard ☕</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div class="sidebar">
    ...
    <a href="menu.html"><i class="bi bi-menu-button"></i> Menu</a>
    <a href="order-status.html"><i class="bi bi-bag-check"></i> Order List</a>
    <a href="analytics.html"><i class="bi bi-graph-up"></i> Analytics</a>
    <a><i class="bi bi-people"></i> Teams</a>
    <a><i class="bi bi-chat-dots"></i> Messages</a>
...
<div class="top-bar mb-4">
    ...
    <div>
        ...
        <span class="ms-3">Sajib Supriyo</span>
...
<div class="row g-4">
    <div class="col-md-6">
        <div class="card-dark">
            <h5>Sales Details</h5>
            <p class="text-muted">February 2023 • Monthly</p>
            <p>● Total Orders • ● Revenue • ● Growth</p>
            <p class="text-muted">(Chart placeholder – connect later)</p>
        </div>
    </div>
...
<div class="mt-5">
    ...
    <div class="row g-4 mt-2">
        <div class="col-md-4">
            <div class="food-card">
                <img src="https://images.unsplash.com/photo-1604908177522-432cf9f3bb95">
                <h6 class="mt-2">Chicken Pot Pie</h6>
                <p>$299</p>
            </div>
        </div>
...
<script>
/* ================= COGNITO LOGOUT PLACEHOLDER ================= */
/* Replace with your real Cognito logout URL later */
function logout() {
    localStorage.clear();
    alert("Logged out (Cognito integration next)");
}
</script>
