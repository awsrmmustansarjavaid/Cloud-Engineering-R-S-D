...
## 📘 TABLE OF CONTENTS (ORDERED BY PRIORITY)

FOUNDATION (You MUST do these first)

High-Level Architecture

AWS Architecture Diagram 

Phase 0 – AWS Account, Region & Billing Setup

Phase 1 – Networking (VPC, Subnets, Routing)

Phase 2 – Compute (EC2 Web Server)

Phase 3 – OS & Runtime (LAMP Stack)

Phase 4 – Local Database (MariaDB – Dev)

Phase 5 – Secrets Manager & IAM (Security Basics)

Phase 6 – Application Code (PHP)

SERVERLESS AUTOMATION (Core Cloud Skills)

Phase 7 – AWS Lambda (Order Processor)

Phase 8 – API Gateway (REST API)

Phase 9 – Lambda + MariaDB Integration

Phase 10 – Testing (Dev Completion)

PRODUCTION UPGRADES (Real Architecture)

Phase 11 – Amazon RDS (Replace Local DB)

Phase 12 – DynamoDB (Menu & Cache)

Phase 13 – Amazon SQS (Async Orders)

Phase 14 – Lambda Worker (Consumer)

SECURITY & PERFORMANCE

Phase 15 – Amazon Cognito (Authentication)

Phase 16 – Amazon CloudFront (CDN + Caching)

Phase 17 – AWS WAF (Protection)

AUTOMATION & COST CONTROL

Phase 18 – CI/CD (CodePipeline + CodeBuild)

Phase 19 – Cost Optimization (All Services)

Phase 20 – Billing, Budgets & Alarms

FINAL

Phase 21 – End-to-End Testing

Phase 22 – Production Deployment (Multi-Region)

Phase 23 – Final Checklist & Architecture Review
