...
a fully final, production-ready Lambda code for your HR Attendance system. This will:

- Use RDS attendance_date correctly

- Keep Pakistan timezone (UTC+5)

- Include employee_id filter

- Include summary calculation
