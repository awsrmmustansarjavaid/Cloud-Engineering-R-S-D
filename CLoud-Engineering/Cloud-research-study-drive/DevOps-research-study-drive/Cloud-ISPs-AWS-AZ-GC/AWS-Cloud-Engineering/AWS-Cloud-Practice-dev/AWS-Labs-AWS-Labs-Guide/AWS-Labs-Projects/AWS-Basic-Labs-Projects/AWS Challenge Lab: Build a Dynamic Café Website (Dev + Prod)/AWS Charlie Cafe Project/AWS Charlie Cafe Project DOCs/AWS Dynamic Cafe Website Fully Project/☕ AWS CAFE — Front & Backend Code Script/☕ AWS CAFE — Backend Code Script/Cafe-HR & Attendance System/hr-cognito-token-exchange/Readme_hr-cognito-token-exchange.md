...
### ✅ Issue 2 — Lambda Token Exchange Uses Double https

- File Lambda : hr-cognito-token-exchange
...
Your COGNITO_DOMAIN in environment may already contain https://.

Then result becomes:

```
https://https://xxxxx/oauth2/token
```
