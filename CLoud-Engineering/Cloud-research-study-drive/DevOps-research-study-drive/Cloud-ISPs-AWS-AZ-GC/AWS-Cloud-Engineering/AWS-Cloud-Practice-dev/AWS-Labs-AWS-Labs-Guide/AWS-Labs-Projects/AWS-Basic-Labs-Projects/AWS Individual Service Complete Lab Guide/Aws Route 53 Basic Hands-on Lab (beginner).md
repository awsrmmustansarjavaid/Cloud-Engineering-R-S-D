...
## 🔬 What this lab teaches you (first-time practice)

### This lab is designed exactly for your first try with Route 53 and covers:

- How DNS actually works (practical view)

- Creating a Public Hosted Zone

- Understanding NS & SOA records
...
- Concept of Alias records

- Proper clean-up to avoid billing

**It is written step-by-step like a real AWS trainer guiding a beginner student.**
